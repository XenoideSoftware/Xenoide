...
wlx::scintilla& wlx::scintilla::create(HWND hParent, int ctrlId, POINT pos, SIZE size)
{
	...
	this->_fnDirect = reinterpret_cast<SciFnDirect>(
		SendMessageW(this->_hWnd, SCI_GETDIRECTFUNCTION, 0, 0));
	this->_ptrDirect = static_cast<sptr_t>(
		SendMessageW(this->_hWnd, SCI_GETDIRECTPOINTER, 0, 0));
	return *this;
}
...
sptr_t wlx::scintilla::send(unsigned msg, uptr_t wp /*= 0*/, sptr_t lp /*= 0*/) const noexcept
{
	...
	return static_cast<sptr_t>(
		SendMessageW(this->_hWnd, msg,
			static_cast<WPARAM>(wp), static_cast<LPARAM>(lp)));
}

wlx::scintilla& wlx::scintilla::set_text(const std::string& text)
{
	this->send(SCI_CLEARALL);
	this->send(SCI_APPENDTEXT,
		static_cast<uptr_t>(text.size()),
...
std::string wlx::scintilla::get_text() const
{
	...
	const intptr_t got = this->send(SCI_GETTEXT,
		static_cast<uptr_t>(buf.size()),
...
{
	this->send(SCI_DELETERANGE,
		static_cast<uptr_t>(pos),
		static_cast<sptr_t>(length));
	return *this;
}
...
std::string wlx::scintilla::text_range(intptr_t start, intptr_t end) const
{
	...
	const intptr_t got = this->send(SCI_GETTEXTRANGE, 0,
...
{
	return static_cast<int>(this->send(SCI_GETCHARAT,
		static_cast<uptr_t>(pos)));
}
...
std::string wlx::scintilla::line_text(intptr_t line) const
{
	...
	if (len <= 0) return {};
	std::string buf(static_cast<size_t>(len) + 1, '\0');
	const intptr_t got = this->send(SCI_GETLINE,
...
{
	this->send(SCI_SETSEL,
		static_cast<uptr_t>(anchor),
...
std::string wlx::scintilla::selected_text() const
{
	...
	if (len <= 0) return {};
	std::string buf(static_cast<size_t>(len) + 1, '\0');
	const intptr_t got = this->send(SCI_GETSELTEXT, 0,
		reinterpret_cast<sptr_t>(buf.data()));
	buf.resize(static_cast<size_t>(got));
	return buf;
}
...
{
	this->send(SCI_STYLESETUNDERLINE,
		static_cast<uptr_t>(styleIndex),
		on ? 1 : 0);
	return *this;
}
...
{
	this->send(SCI_STYLESETEOLFILLED,
		static_cast<uptr_t>(styleIndex),
		on ? 1 : 0);
	return *this;
}
...
{
	this->send(SCI_SETLEXERLANGUAGE, 0,
		reinterpret_cast<sptr_t>(name));
	return *this;
}

wlx::scintilla& wlx::scintilla::colourise(intptr_t start, intptr_t end) noexcept
{
	this->send(SCI_COLOURISE,
		static_cast<uptr_t>(start),
		static_cast<sptr_t>(end));
	return *this;
}

wlx::scintilla& wlx::scintilla::set_margin_type(int margin, int type) noexcept
{
	this->send(SCI_SETMARGINTYPEN,
		static_cast<uptr_t>(margin), static_cast<sptr_t>(type));
	return *this;
}

wlx::scintilla& wlx::scintilla::set_margin_width(int margin, int pixels) noexcept
{
	this->send(SCI_SETMARGINWIDTHN,
		static_cast<uptr_t>(margin), static_cast<sptr_t>(pixels));
	return *this;
}

wlx::scintilla& wlx::scintilla::set_margin_mask(int margin, int mask) noexcept
{
	this->send(SCI_SETMARGINMASKN,
		static_cast<uptr_t>(margin), static_cast<sptr_t>(mask));
	return *this;
}

wlx::scintilla& wlx::scintilla::set_margin_sensitive(int margin, bool sensitive) noexcept
{
	this->send(SCI_SETMARGINSENSITIVEN,
		static_cast<uptr_t>(margin), sensitive ? 1 : 0);
	return *this;
}
...
{
	this->send(SCI_MARKERDEFINE,
		static_cast<uptr_t>(markerNum), static_cast<sptr_t>(symbol));
	return *this;
}

wlx::scintilla& wlx::scintilla::marker_set_fore(int markerNum, COLORREF colour) noexcept
{
	this->send(SCI_MARKERSETFORE,
		static_cast<uptr_t>(markerNum), static_cast<sptr_t>(colour));
	return *this;
}

wlx::scintilla& wlx::scintilla::marker_set_back(int markerNum, COLORREF colour) noexcept
{
	this->send(SCI_MARKERSETBACK,
		static_cast<uptr_t>(markerNum), static_cast<sptr_t>(colour));
	return *this;
}
...
{
	return static_cast<int>(this->send(SCI_MARKERADD,
		static_cast<uptr_t>(line), static_cast<sptr_t>(markerNum)));
}

wlx::scintilla& wlx::scintilla::marker_delete(intptr_t line, int markerNum) noexcept
{
	this->send(SCI_MARKERDELETE,
		static_cast<uptr_t>(line), static_cast<sptr_t>(markerNum));
	return *this;
}
...
{
	this->send(SCI_INDICSETSTYLE,
		static_cast<uptr_t>(indicator), static_cast<sptr_t>(indicatorStyle));
	return *this;
}

wlx::scintilla& wlx::scintilla::indicator_set_fore(int indicator, COLORREF colour) noexcept
{
	this->send(SCI_INDICSETFORE,
		static_cast<uptr_t>(indicator), static_cast<sptr_t>(colour));
	return *this;
}
...
{
	this->send(SCI_INDICATORFILLRANGE,
		static_cast<uptr_t>(pos), static_cast<sptr_t>(length));
	return *this;
}

wlx::scintilla& wlx::scintilla::indicator_clear_range(intptr_t pos, intptr_t length) noexcept
{
	this->send(SCI_INDICATORCLEARRANGE,
		static_cast<uptr_t>(pos), static_cast<sptr_t>(length));
	return *this;
}
...
{
	this->send(SCI_FOLDLINE,
		static_cast<uptr_t>(line), static_cast<sptr_t>(action));
	return *this;
}
...
{
	this->send(SCI_SETTARGETRANGE,
		static_cast<uptr_t>(start), static_cast<sptr_t>(end));
	return *this;
}
...
{
	return this->send(SCI_SEARCHINTARGET,
		static_cast<uptr_t>(text.size()),
		reinterpret_cast<sptr_t>(text.data()));
}
...
{
	return this->send(SCI_REPLACETARGET,
		static_cast<uptr_t>(text.size()),
		reinterpret_cast<sptr_t>(text.data()));
}
...
intptr_t wlx::scintilla::find_text(int flags, intptr_t start, intptr_t end, const std::string& text)
{
	...
	return this->send(SCI_FINDTEXT,
		static_cast<uptr_t>(flags),
		reinterpret_cast<sptr_t>(&ttf));
}

wlx::scintilla& wlx::scintilla::set_tab_width(int width) noexcept
{
	this->send(SCI_SETTABWIDTH, static_cast<uptr_t>(width)); return *this;
}

wlx::scintilla& wlx::scintilla::set_use_tabs(bool on) noexcept
{
	this->send(SCI_SETUSETABS, on ? 1u : 0u); return *this;
}

wlx::scintilla& wlx::scintilla::set_indent(int width) noexcept
{
	this->send(SCI_SETINDENT, static_cast<uptr_t>(width)); return *this;
}

wlx::scintilla& wlx::scintilla::set_eol_mode(int mode) noexcept
{
	this->send(SCI_SETEOLMODE, static_cast<uptr_t>(mode)); return *this;
}

wlx::scintilla& wlx::scintilla::convert_eols(int mode) noexcept
{
	this->send(SCI_CONVERTEOLS, static_cast<uptr_t>(mode)); return *this;
}

wlx::scintilla& wlx::scintilla::set_view_eol(bool on) noexcept
{
	this->send(SCI_SETVIEWEOL, on ? 1u : 0u); return *this;
}

wlx::scintilla& wlx::scintilla::set_view_whitespace(int mode) noexcept
{
	this->send(SCI_SETVIEWWS, static_cast<uptr_t>(mode)); return *this;
}

wlx::scintilla& wlx::scintilla::set_word_wrap(int mode) noexcept
{
	this->send(SCI_SETWRAPMODE, static_cast<uptr_t>(mode)); return *this;
}

wlx::scintilla& wlx::scintilla::set_caret_line_visible(bool on) noexcept
{
	this->send(SCI_SETCARETLINEVISIBLE, on ? 1u : 0u); return *this;
}

wlx::scintilla& wlx::scintilla::set_caret_line_back(COLORREF c) noexcept
{
	this->send(SCI_SETCARETLINEBACK, static_cast<uptr_t>(c)); return *this;
}

wlx::scintilla& wlx::scintilla::set_zoom(int level) noexcept
{
	this->send(SCI_SETZOOM, static_cast<uptr_t>(level)); return *this;
}

wlx::scintilla& wlx::scintilla::zoom_in() noexcept
{
	this->send(SCI_ZOOMIN); return *this;
}

wlx::scintilla& wlx::scintilla::zoom_out() noexcept
{
	this->send(SCI_ZOOMOUT); return *this;
}

void wlx::scintilla::process_notify(const SCNotification& n) noexcept
{
	switch (n.nmhdr.code) {
	case SCN_MODIFIED:          if (this->_onModified)         this->_onModified(n); return;
	case SCN_SAVEPOINTREACHED:  if (this->_onSavePointReached) this->_onSavePointReached(); return;
	case SCN_SAVEPOINTLEFT:     if (this->_onSavePointLeft)    this->_onSavePointLeft(); return;
	case SCN_CHARADDED:         if (this->_onCharAdded)        this->_onCharAdded(n.ch); return;
	case SCN_UPDATEUI:          if (this->_onUpdateUi)         this->_onUpdateUi(n.updated); return;
	case SCN_MARGINCLICK:       if (this->_onMarginClick)
		this->_onMarginClick(static_cast<intptr_t>(n.position),
			n.margin, n.modifiers);
		return;
	case SCN_DOUBLECLICK:       if (this->_onDoubleClick)
		this->_onDoubleClick(static_cast<intptr_t>(n.position),
			static_cast<intptr_t>(n.line),
			n.modifiers);
		return;
	case SCN_ZOOM:              if (this->_onZoom)             this->_onZoom(); return;
	case SCN_FOCUSIN:           if (this->_onFocusIn)          this->_onFocusIn(); return;
	case SCN_FOCUSOUT:          if (this->_onFocusOut)         this->_onFocusOut(); return;
	case SCN_KEY:               if (this->_onKey)              this->_onKey(n.ch); return;
	default:                    if (this->_onUnhandledNotify)  this->_onUnhandledNotify(n); return;
	}
}

wlx::scintilla& wlx::scintilla::on_modified(std::function<void(const SCNotification&)> fn)
{
	this->_onModified = std::move(fn);  return *this;
}

wlx::scintilla& wlx::scintilla::on_save_point_reached(std::function<void()> fn)
{
	this->_onSavePointReached = std::move(fn);  return *this;
}

wlx::scintilla& wlx::scintilla::on_save_point_left(std::function<void()> fn)
{
	this->_onSavePointLeft = std::move(fn);  return *this;
}

wlx::scintilla& wlx::scintilla::on_char_added(std::function<void(int)> fn)
{
	this->_onCharAdded = std::move(fn);  return *this;
}

wlx::scintilla& wlx::scintilla::on_update_ui(std::function<void(int)> fn)
{
	this->_onUpdateUi = std::move(fn);  return *this;
}

wlx::scintilla& wlx::scintilla::on_margin_click(std::function<void(intptr_t, int, int)> fn)
{
	this->_onMarginClick = std::move(fn);  return *this;
}

wlx::scintilla& wlx::scintilla::on_double_click(std::function<void(intptr_t, intptr_t, int)> fn)
{
	this->_onDoubleClick = std::move(fn);  return *this;
}

wlx::scintilla& wlx::scintilla::on_zoom(std::function<void()> fn)
{
	this->_onZoom = std::move(fn);  return *this;
}

wlx::scintilla& wlx::scintilla::on_focus_in(std::function<void()> fn)
{
	this->_onFocusIn = std::move(fn);  return *this;
}

wlx::scintilla& wlx::scintilla::on_focus_out(std::function<void()> fn)
{
	this->_onFocusOut = std::move(fn);  return *this;
}

wlx::scintilla& wlx::scintilla::on_key(std::function<void(int)> fn)
{
	this->_onKey = std::move(fn);  return *this;
}

wlx::scintilla& wlx::scintilla::on_unhandled_notify(std::function<void(const SCNotification&)> fn)
{
	this->_onUnhandledNotify = std::move(fn);  return *this;
}
