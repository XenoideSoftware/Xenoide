...
wlx::toolbar::toolbar() : wl::wnd(_hWnd), base_native_ctrl_pubm(_baseNativeCtrl), base_focus_pubm(_hWnd) {
}
...
wlx::toolbar &wlx::toolbar::create(HWND hParent, int ctrlId, POINT pos, SIZE size) {
    ...
    this->_baseNativeCtrl.create(
        ...
        size,
        TOOLBARCLASSNAME,
        WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS | TBSTYLE_TOOLTIPS | TBSTYLE_WRAPABLE | CCS_NODIVIDER | CCS_NOPARENTALIGN | CCS_NORESIZE,
        0
    );
    ...
    HIMAGELIST hil = reinterpret_cast<HIMAGELIST>(SendMessageW(this->_hWnd, TB_LOADIMAGES, IDB_STD_SMALL_COLOR, reinterpret_cast<LPARAM>(HINST_COMMCTRL)));
    if (hil) {
        SendMessageW(this->_hWnd, TB_SETIMAGELIST, 0, reinterpret_cast<LPARAM>(hil));
    }
    return *this;
}
...
wlx::toolbar &wlx::toolbar::add_button(int idCommand, int stdBitmap, const TCHAR *label, BYTE styles, BYTE state) {
    ...
    LRESULT r = SendMessageW(this->_hWnd, TB_ADDBUTTONS, 1, reinterpret_cast<LPARAM>(&tbb));
...
wlx::toolbar &wlx::toolbar::add_button(int idCommand, int stdBitmap, const wl::tstring &label, BYTE styles, BYTE state) {
    return this->add_button(idCommand, stdBitmap, label.c_str(), styles, state);
}

wlx::toolbar &wlx::toolbar::add_button_bitmap(int idCommand, int bitmapIndex, const TCHAR *label, BYTE styles, BYTE state) {
    TBBUTTON tbb{};
...
wlx::toolbar &wlx::toolbar::add_separator(int width) {
    ...
    SendMessageW(this->_hWnd, TB_ADDBUTTONS, 1, reinterpret_cast<LPARAM>(&tbb));
    // Restore default auto button width so subsequent buttons aren't affected.
    SendMessageW(this->_hWnd, TB_SETBUTTONWIDTH, 0, 0);
    return *this;
}

wlx::toolbar &wlx::toolbar::insert_button(int index, int idCommand, int stdBitmap, const TCHAR *label, BYTE styles, BYTE state) {
    if (index < 0)
        return this->add_button(idCommand, stdBitmap, label, styles, state);
    TBBUTTON tbb{};
    tbb.iBitmap = stdBitmap;
    tbb.idCommand = idCommand;
    tbb.fsState = state;
    tbb.fsStyle = styles;
    tbb.iString = reinterpret_cast<INT_PTR>(label ? label : _T(""));
    LRESULT r = SendMessageW(this->_hWnd, TB_INSERTBUTTON, static_cast<WPARAM>(index), reinterpret_cast<LPARAM>(&tbb));
...
int wlx::toolbar::button_index(int idCommand) const noexcept {
    return static_cast<int>(SendMessageW(this->_hWnd, TB_COMMANDTOINDEX, static_cast<WPARAM>(idCommand), 0));
}

int wlx::toolbar::button_count() const noexcept {
    return static_cast<int>(SendMessageW(this->_hWnd, TB_BUTTONCOUNT, 0, 0));
}

TBBUTTON wlx::toolbar::button_info(int index) const {
    TBBUTTON tbb{};
    if (SendMessageW(this->_hWnd, TB_GETBUTTON, static_cast<WPARAM>(index), reinterpret_cast<LPARAM>(&tbb)) == FALSE) {
...
wlx::toolbar &wlx::toolbar::set_button_info(int index, int cmd, int bitmap) noexcept {
    ...
    if (tbbi.dwMask != 0) {
        SendMessageW(this->_hWnd, TB_SETBUTTONINFO, static_cast<WPARAM>(index), reinterpret_cast<LPARAM>(&tbbi));
    }
    return *this;
}
...
wlx::toolbar &wlx::toolbar::enable_button(int idCommand, bool enable) noexcept {
    SendMessageW(this->_hWnd, TB_ENABLEBUTTON, static_cast<WPARAM>(idCommand), enable ? MAKELPARAM(TBSTATE_ENABLED, 0) : MAKELPARAM(0, 0));
    return *this;
}

wlx::toolbar &wlx::toolbar::check_button(int idCommand, bool check) noexcept {
    SendMessageW(this->_hWnd, TB_CHECKBUTTON, static_cast<WPARAM>(idCommand), check ? MAKELPARAM(TBSTATE_CHECKED, 0) : MAKELPARAM(0, 0));
    return *this;
}

wlx::toolbar &wlx::toolbar::press_button(int idCommand, bool press) noexcept {
    SendMessageW(this->_hWnd, TB_PRESSBUTTON, static_cast<WPARAM>(idCommand), press ? MAKELPARAM(TBSTATE_PRESSED, 0) : MAKELPARAM(0, 0));
    return *this;
}

wlx::toolbar &wlx::toolbar::hide_button(int idCommand, bool hide) noexcept {
    SendMessageW(this->_hWnd, TB_HIDEBUTTON, static_cast<WPARAM>(idCommand), hide ? MAKELPARAM(TBSTATE_HIDDEN, 0) : MAKELPARAM(0, 0));
    return *this;
}
...
BYTE wlx::toolbar::button_state(int idCommand) const noexcept {
    ...
    if (SendMessageW(this->_hWnd, TB_GETBUTTONINFO, static_cast<WPARAM>(idCommand), reinterpret_cast<LPARAM>(&tbbi)) == -1) {
        return 0;
    }
    return tbbi.fsState;
}
...
wlx::toolbar &wlx::toolbar::set_image_list(HIMAGELIST himl) noexcept {
    SendMessageW(this->_hWnd, TB_SETIMAGELIST, 0, reinterpret_cast<LPARAM>(himl));
    return *this;
}

wlx::toolbar &wlx::toolbar::set_disabled_image_list(HIMAGELIST himl) noexcept {
    SendMessageW(this->_hWnd, TB_SETDISABLEDIMAGELIST, 0, reinterpret_cast<LPARAM>(himl));
    return *this;
}

wlx::toolbar &wlx::toolbar::set_hot_image_list(HIMAGELIST himl) noexcept {
    SendMessageW(this->_hWnd, TB_SETHOTIMAGELIST, 0, reinterpret_cast<LPARAM>(himl));
    return *this;
}

wlx::toolbar &wlx::toolbar::add_std_bitmaps(int resId, int n) noexcept {
    SendMessageW(this->_hWnd, TB_LOADIMAGES, static_cast<WPARAM>(resId), reinterpret_cast<LPARAM>(HINST_COMMCTRL));
...
wlx::toolbar &wlx::toolbar::add_user_bitmaps(HBITMAP hBmp, int n) noexcept {
    SendMessageW(this->_hWnd, TB_ADDBITMAP, static_cast<WPARAM>(n), reinterpret_cast<LPARAM>(&hBmp));
    return *this;
}
...
wlx::toolbar &wlx::toolbar::set_button_size(int width, int height) noexcept {
    SendMessageW(this->_hWnd, TB_SETBUTTONSIZE, 0, MAKELPARAM(width, height));
    return *this;
}

wlx::toolbar &wlx::toolbar::set_padding(int cx, int cy) noexcept {
    SendMessageW(this->_hWnd, TB_SETPADDING, 0, MAKELPARAM(cx, cy));
    return *this;
}
...
int wlx::toolbar::height() const noexcept {
    DWORD dw = static_cast<DWORD>(SendMessageW(this->_hWnd, TB_GETBUTTONSIZE, 0, 0));
...
wlx::toolbar &wlx::toolbar::set_extended_style(DWORD mask, DWORD extendedStyle) noexcept {
    SendMessageW(this->_hWnd, TB_SETEXTENDEDSTYLE, static_cast<WPARAM>(mask), static_cast<LPARAM>(extendedStyle));
    return *this;
}

DWORD wlx::toolbar::extended_style() const noexcept {
    return static_cast<DWORD>(SendMessageW(this->_hWnd, TB_GETEXTENDEDSTYLE, 0, 0));
}
...
HWND wlx::toolbar::tooltip_hwnd() const noexcept {
    return reinterpret_cast<HWND>(SendMessageW(this->_hWnd, TB_GETTOOLTIPS, 0, 0));
}
...
wlx::toolbar &wlx::toolbar::set_tooltip_max_width(int pixels) noexcept {
    HWND hTip = this->tooltip_hwnd();
    if (hTip) {
        SendMessageW(hTip, TTM_SETMAXTIPWIDTH, 0, static_cast<LPARAM>(pixels));
    }
    return *this;
}
