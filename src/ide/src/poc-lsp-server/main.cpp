        ...
        handler
            .add<lsp::requests::Initialize>([](lsp::requests::Initialize::Params &&params) {
                ...
                return lsp::requests::Initialize::Result{
                    ...
                    .serverInfo = lsp::InitializeResultServerInfo{.name = "poc-lsp-server", .version = "0.1.0"},
                };
            })
            .add<lsp::requests::TextDocument_Hover>([](lsp::requests::TextDocument_Hover::Params &&params) {
                ...
                return std::async(std::launch::deferred, [params = std::move(params)]() {
                    return lsp::requests::TextDocument_Hover::Result(lsp::Hover{.contents = "Hello from poc-lsp-server!"});
                });
            })
