...
FindReplaceWindow::FindReplaceWindow() {
    ...
    on_message(WM_CREATE, [this](wl::wm::size p) -> LRESULT {
        ...
        this->_resz.add(this->_txtSearch, wl::resizer::go::RESIZE, wl::resizer::go::NOTHING)
            ...
            .add({this->_btnFindNext, this->_btnReplace, this->_btnReplaceAll, this->_btnCancel}, wl::resizer::go::REPOS, wl::resizer::go::REPOS);

        return 0;
    });

    on_message(WM_SIZE, [this](wl::wm::create p) -> LRESULT { return 0; });
}
