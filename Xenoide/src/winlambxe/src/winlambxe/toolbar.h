...
class toolbar final :
    public wl::wnd,
    public wl::_wli::base_native_ctrl_pubm<toolbar>,
    public wl::_wli::base_focus_pubm<toolbar>
{
private:
    HWND                        _hWnd = nullptr;
...
public:
     ...
     */
    toolbar& add_button(int idCommand, int stdBitmap, const TCHAR* label,
                        BYTE styles = BTNS_BUTTON, BYTE state = TBSTATE_ENABLED);

    /** @overload Accepts an @c wl::tstring label. */
    toolbar& add_button(int idCommand, int stdBitmap, const wl::tstring& label,
                        BYTE styles = BTNS_BUTTON, BYTE state = TBSTATE_ENABLED);
     ...
     */
    toolbar& add_button_bitmap(int idCommand, int bitmapIndex, const TCHAR* label,
                               BYTE styles = BTNS_BUTTON, BYTE state = TBSTATE_ENABLED);
     ...
     */
    toolbar& insert_button(int index, int idCommand, int stdBitmap, const TCHAR* label,
                           BYTE styles = BTNS_BUTTON, BYTE state = TBSTATE_ENABLED);
